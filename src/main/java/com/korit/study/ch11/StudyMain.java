...
public class StudyMain {
    public static void main(String[] args) {
        ...
        Subject subject = new Subject("JAVA기초", teacher);
        ...
        for (int i = 0; i < study.students.length; i++) {
            System.out.println("학생" + (i + 1) + " ID: " + study.students[i].Id);
            System.out.println("학생"  + (i + 1) + " 이름: " + study.students[i].name);
            System.out.println("학생" + (i + 1) + " 나이: " + study.students[i].age);
        }
