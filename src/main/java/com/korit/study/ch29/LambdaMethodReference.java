...
public class LambdaMethodReference {
    public static void main(String[] args) {
        Consumer<String> stringConsumer = (s) -> System.out.println(s); // .accept 와 동일한 기능을 한다
        stringConsumer.accept("람다 메서드 참조");


        Consumer<String> stringConsumer2 = (s) -> StrPrinter.print(s);
        stringConsumer2.accept("람다 메서드 참조");//accept 호출 -> s 대입 -> 바로 print 호출

        Consumer<String> stringConsumer3 =  System.out::println; //accept -> println에 대입
        ...
        Student student2 = biFunction2.apply("김준ㅇ리", 32);
        ...
        strNums.stream()
                .map(str -> Integer.parseInt(str)) //map 안에function
